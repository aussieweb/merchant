<?php
	 ...
	 */
	function beacon_display_supply_count( $atts ) {
		...
		// Get plan
		$plan = get_post_meta( $supply['id'], 'beacon_' . $supply['type'] . '_details', true );
	...
	add_shortcode( 'beacon_limited_supply', 'beacon_display_supply_count' );